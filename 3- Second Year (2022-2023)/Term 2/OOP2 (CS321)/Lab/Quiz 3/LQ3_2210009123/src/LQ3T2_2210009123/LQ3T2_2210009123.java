// Lab Question 3 Task 2 - 2210009123
// Filtered JFileChooser to .txt only
...
class JFileChooserDemo extends JFrame
{
   ...
   {
      super("221009123 - JFileChooser Filtered to .txt only");
   ...
   // allow user to specify file or directory name
    ...
    {
        // configure dialog allowing selection of a file that has .txt extension
